          ...
          <div class="right-box">
            ...
            <div class="l-t-b">
              <div v-for="(item,index) in xiaoxi" :key="index">
                <!-- 当前用户输入信息 -->
                <div v-if="item.leave==='' || item.enter===''">
              ...
              <div v-else>
              <!-- 上线 -->
               <div v-if="item.leave && item.enter===''" class="l-l-l">{{item.leave}}退出群聊</div>
                <!-- 下线 -->
                <div v-if="item.enter && item.leave===''  " class="l-l-l">{{item.enter}}加入群聊</div>
              </div>
            ...
            <div class="que-ding">
              按下Ctrl+Enter发送
              <button @click="sendMessage" class="fasong">发送</button>
            </div>
          </div>
        </div>
      </div>
